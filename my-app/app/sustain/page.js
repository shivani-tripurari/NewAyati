  ...
  return (
    <>
        <div className='relative bg-[#FBBC89] pb-10 w-[100%]'>
            <div className='bg-[#1B3540] h-[40vh] lg:h-[56vh]'>
                <Navbar/>
            ...
            {/* text */}
            <h1 className='text-[#1B3540] text-center pr-7 lg:text-left text-3xl font-medium lg:text-5xl mb-4 pb-7 uppercase'>Sustainability<br/>
            The Smart Way</h1>
